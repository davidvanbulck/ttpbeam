...
module TTPSolver
    ...
    using LightXML
    function create_xml_from_matrix(rounds_matrix, instanceFile, bestObj)
	...
	add_text(c, "Generated by David Van Bulck, using the beam search algorithm by Frohner et al.")
	...
	add_text(c, "H")
        ...
        for r in 1:size(rounds_matrix, 1)
            for team1 in 1:size(rounds_matrix, 2)
                team2 = rounds_matrix[r, team1]
        ...
        println("XML file '$solution_filename' created successfully.")
    	flush(stdout)
    end
